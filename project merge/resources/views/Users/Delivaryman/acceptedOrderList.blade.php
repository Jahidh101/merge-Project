    ...
    @foreach($data as $da)
        ...
        <tr>
            ...
            <td>
                ...
                @elseif ($da['status'] == 9)
                    <p class="text-success">Product received</p>
                @endif
            </td>
            ...
            @if ($da['status'] == 5)
                <td> <a class="btn btn-success" href="{{route('delivaryman.delivary.success',['id' =>$da['order_id']])}}"> Complete </a></td>
            @elseif ($da['status'] == 9)
                <td> <a class="btn btn-success" href="{{route('delivaryman.delivary.paid',['id' =>$da['order_id']])}}"> Paid </a></td>
            @endif
            </form>
        </tr>
        @endif
